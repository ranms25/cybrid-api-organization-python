...
from cybrid_api_organization.api.organizations_organization_api import OrganizationsOrganizationApi  # noqa: E501


class TestOrganizationsOrganizationApi(unittest.TestCase):
    """OrganizationsOrganizationApi unit test stubs"""

    def setUp(self):
        self.api = OrganizationsOrganizationApi()  # noqa: E501
